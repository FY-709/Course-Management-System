...
<div class="container my-3" text-align="center">
    <div class="shadow p-3 mb-5 bg-white rounded-lg">
        <h4 class="text-center my-2">已选课程</h4>
        <form action="${pageContext.request.contextPath}/student/cancelCourse" method="post">
            <div class="row mx-3 my-3">
                ...
                <div class="col-auto">
                    <button type="submit" class="btn btn-outline-primary">退选</button>
                </div>
            </div>
